...
const APP_DETAILS: Record<string, {
  ...
  travii: {
    ...
    fullDescription: [
      ...
      "Built with React Native and Expo, Travii delivers a polished mobile experience with fluid animations, offline support, and seamless device integration.",
    ],
    features: [
  ...
  morrii: {
    ...
    fullDescription: [
      ...
      "Crafted with React Native and Expo, Morrii embraces a calm, premium aesthetic that feels right at home on any iPhone.",
    ],
    features: [
